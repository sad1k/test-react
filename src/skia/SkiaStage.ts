 ...
 *
 * Метод {@link render} вызывается по требованию (из `PixiSkiaApp.renderAll`
 * после смены сцены, добавления фигуры и т.п. — без непрерывного rAF): он
 * заново обходит дерево сцены и рисует его средствами Skia, поэтому второй
